                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                        	...
                        	<form action="<%=path %>/jsp/behind/registlist.jsp" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="pass" value="${sessionScope.user.pass}" class="form-control" placeholder="密码"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">手机号</label>
                                    <input type="text" name="phone" value="${sessionScope.user.phone}" class="form-control" placeholder="手机号"  required/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">E-mail</label>
                                    <input type="text" name="mail" value="${sessionScope.user.mail}" class="form-control" placeholder="E-mail" required/>
                                </div>
                                <div class="form-group">
