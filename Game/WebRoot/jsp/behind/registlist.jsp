                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                        	...
                        	<form action="<%=path %>/jsp/behind/user.jsp" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="${sessionScope.user.name}" class="form-control" placeholder="用户名" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">密码</label>
                                    <input type="password" name="pass" value="${sessionScope.user.pass}" class="form-control" placeholder="密码" readonly="readonly"/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">手机号</label>
                                    <input type="text" name="phone" value="${sessionScope.user.phone}" class="form-control" placeholder="手机号" readonly="readonly"/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">E-mail</label>
                                    <input type="text" name="mail" value="${sessionScope.user.mail}" class="form-control" placeholder="E-mail" readonly="readonly"/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">真实姓名</label>
                                    <input type="text" name="realname" value="${sessionScope.user.realname}" class="form-control" placeholder="真实姓名" readonly="readonly" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">身份证号</label>
                                    <input type="text" name="idnumber" value="${sessionScope.user.idnumber}" class="form-control" placeholder="身份证号" readonly="readonly"/>
                                </div>
                                <input type="submit" class="btn btn-default" value="修改信息" />
                            </form>
                        	</div>                         
                        </div>                    
                    </div>
