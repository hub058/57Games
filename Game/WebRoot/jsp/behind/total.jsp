                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                        	...
                        	<form action="<%=path %>/recharge.do" method="post">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">用户名</label>
                                    <input type="text" name="name" value="${sessionScope.user.name}" class="form-control" placeholder="用户名"/>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">账号类型：  盛大游戏通行证</label>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">充值类型：  盛大游戏点券</label>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">充值金额</label>
                                    <input type="text" name="money"  class="form-control" placeholder="充值金额"/>
                                </div>
