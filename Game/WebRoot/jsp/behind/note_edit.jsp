                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                        	...
                        	<form action="<%=path %>/updateNote.do" method="post">
								<input type="hidden" value="${note.id}" name="id">
								<input type="hidden" name="date" value="${note.date}" />
                                <div class="form-group">
                                    <label for="exampleInputPassword1">标题</label>
                                    <input type="text" name="title" value="${note.title}" class="form-control" placeholder="标题" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">内容</label>
                                    <input type="text" name="content" value="${note.content}" class="form-control" placeholder="内容" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">发布人</label>
                                    <input type="text" name="user" value="${note.user}" class="form-control" placeholder="发布人" readonly="readonly"/>
                                </div>
